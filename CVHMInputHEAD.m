...
fid = fopen([opt.simFolder filesep opt.prefix '_' opt.timestring  '_BC_h' num2str(opt.std_Htol) '.npsat'], 'w');
fprintf(fid, '%d\n', length(BND_LINES));
for ii = 1:length(BND_LINES)
...
writeScatteredData([opt.simFolder filesep opt.prefix '_' opt.timestring  '_Top_iter_' num2str(1) '.npsat'], struct('PDIM',2,'TYPE','HOR','MODE','SIMPLE'), xy_top);